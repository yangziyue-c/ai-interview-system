...
| 角色 | 人数 | 职责 |
| :--- | :---: | :--- |
| P1 后端开发A（兼技术负责人） | 1人 | 主后端 `backend/app/`：数据库设计、面试流程状态机、对话管理API、题库导入/查询接口、适配器集成、部署运维、进度把控 |
...
| P5 知识库构建 + 测试/文档 | 1人 | 整理各岗位面试题库 xlsx（V4，含参考答案/难度/得分点/追问触发条件）、知识点库，功能测试与文档 |
