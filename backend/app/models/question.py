...
# V4（2026-09-06）大类拆分：「场景与设计」拆为「系统设计题」+「场景题」
QUESTION_CATEGORIES = ("技术知识", "系统设计题", "场景题", "编码与算法", "项目深挖", "行为面试")
...
class Question(Base):
    ...
    # V4 新增第 16 列：表达评估要点（沟通表达维度的评分素材，供 P3 评分 Prompt 使用）
    expression_points: Mapped[str] = mapped_column(Text, default="", comment="表达评估要点")
